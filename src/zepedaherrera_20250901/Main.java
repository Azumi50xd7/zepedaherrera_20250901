 ...
 */
package zepedaherrera_20250901;
...
public class Main {
    ...
    //SE INTANCIA EL SCANNER PARA LECTURA DE TECLADO
        Scanner scanner = new Scanner(System.in);
    
        //SE INSTANCIA LA MATRIZ DE TIPO  INTEFGER
    ...
    //SALIDA AL USUARIO PARA INDICAR QUE DEBE INGRESAR DATOS
        System.out.println("ingrese los valores de una matriz de 3 x 3");
        ...
        for(int i=0; i<matriz.length; i++){
            ...
            for(int j = 0; j < matriz [i].length; j++){
                //SE VUELVE UN ARRAY-----
                //SE IMPRIME LA PETICION AL USUARIO PARA EL INGRESO DE 
